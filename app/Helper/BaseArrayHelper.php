...
/**
 * Description of BaseArrayHelper
 *
 * @author nthanh
 */
class BaseArrayHelper
{
    ...
    /**
     * @author: NTHanh
     * @todo Merges two or more arrays into one recursively.
     ...
     * @param mixed $default the default value to be returned if the specified array key does not exist getting value from an object.
