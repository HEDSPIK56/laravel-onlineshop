...
/**
 * Description of UploadsManagerService
 *
 * @author nthanh
 */
class UploadsManagerService
{
    ...
    {
        $this->disk = Storage::disk(config('upload.uploads.storage'));
    ...
    {
        $path = rtrim(config('public.uploads.webpath'), '/') . '/' . ltrim($path, '/');
    ...
    public function deleteDirectory($folder)
    {
        ...
        $filesFolders = array_merge(
                $this->disk->directories($folder), $this->disk->files($folder)
        );
